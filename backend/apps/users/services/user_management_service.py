...
class UserManagementService:
    """Service dùng chung cho việc quản lý người dùng - khóa/mở khóa, danh sách."""
    ...
    def toggle_user_active(user, admin_user, reason=""):
        ...
        if user.is_active:
            ...
            UserManagementService._blacklist_user_tokens(user)
    ...
    def get_managed_users(search=None, role=None, status=None, page=1, page_size=10):
        ...
        """
        return UserRepository.get_managed_users(search, role, status, page, page_size)
