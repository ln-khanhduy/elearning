...
class InstructorManagerRepository:
    """Repository quản lý danh sách giảng viên cho Instructor Manager."""
    ...
    def get_instructors(search=None, status=None):
        ...
        """
        instructor_role = InstructorManagerRepository.get_instructor_role()
