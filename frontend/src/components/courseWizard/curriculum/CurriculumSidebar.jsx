 ...
 */
function CurriculumSidebar({ curriculum, selectedItem, isPublished = false, onSelectLesson, onSelectQuiz, onEditSection,
  ...
  return (
    <div className="cw-curriculum-sidebar">
      <div className="cw-curriculum-header">
        ...
        <button className="cw-btn cw-btn-primary cw-btn-sm" onClick={onAddSection} disabled={isPublished}>
      ...
      <div className="cw-curriculum-scroll">
        {curriculum.length === 0 ? (
          <div className="cw-empty-state">
            ...
            <button className="cw-btn cw-btn-primary" onClick={onAddSection} disabled={isPublished}>
          ...
          curriculum.map((section, idx) => (
            <SectionCard key={section.id} section={section} index={idx} selectedItem={selectedItem}
              isPublished={isPublished} onSelectLesson={onSelectLesson} onSelectQuiz={onSelectQuiz}
              onEditSection={onEditSection} onDeleteSection={onDeleteSection} onAddLesson={onAddLesson}
              onAddQuiz={onAddQuiz} onDeleteLesson={onDeleteLesson} onDeleteQuiz={onDeleteQuiz} />
          ))
        )}
      </div>
    </div>
